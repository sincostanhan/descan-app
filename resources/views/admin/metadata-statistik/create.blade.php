<x-layout-admin title="Tambah Metadata Statistik">
    <x-hero
        title="Tambah Metadata Statistik Baru"
    />

    <div class="max-w-4xl mx-auto px-4 lg:px-0 mb-12">
        <x-section-card title="Tambah Metadata Statistik" title-size="text-xl">

                <form action="{{ route('admin.metadata-statistik.store') }}" method="POST"
                        ...
                        <div id="preview-container" class="hidden mt-6">
                            <div class="tabs tabs-border">
                                ...
                                <div class="tab-content border-base-300 bg-base-50 p-4">
                                    <iframe id="pdf-iframe" class="w-full h-125 border border-base-300 shadow-sm rounded bg-white hidden"></iframe>
    ...
    {{-- cover extraction, sama seperti infografis --}}
    @push('scripts')
