                                ...
                                @foreach($publications as $pub)
                                    <tr>
                                        ...
                                        whitespace-nowrap">
                                            ...
                                            <form id="form-delete-publication-{{ $pub->id }}" action="{{ route('admin.publication.destroy', $pub->id) }}" method="POST" class="inline-block">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                            <button type="button" onclick="document.getElementById('modal_confirm_delete_publication_{{ $pub->id }}').showModal()" class="btn btn-soft btn-error btn-sm">
                                                Hapus
                                            </button>

                                            <dialog id="modal_confirm_delete_publication_{{ $pub->id }}" class="modal">
                                                <div class="modal-box">
                                                    <div class="flex flex-col items-center text-center">
                                                        ...
                                                        <p class="py-4 text-base-content/80">Yakin ingin menghapus publikasi ini?</p>
                                                    </div>
                                                    <div class="modal-action justify-center">
                                                        <form method="dialog">
                                                            <button class="btn btn-ghost">Batal</button>
                                                        </form>
                                                        <button type="submit" form="form-delete-publication-{{ $pub->id }}" class="btn btn-error">
                                                            Ya, Hapus
                                                        </button>
                                                    </div>
                                                </div>
